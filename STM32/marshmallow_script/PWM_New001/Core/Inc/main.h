...
#define L_AIN2_Pin GPIO_PIN_4
#define L_AIN2_GPIO_Port GPIOC
#define L_AIN1_Pin GPIO_PIN_5
...
#define R_AIN2_Pin GPIO_PIN_12
#define R_AIN2_GPIO_Port GPIOC
#define R_AIN1_Pin GPIO_PIN_2
#define R_AIN1_GPIO_Port GPIOD
#define R_BIN1_Pin GPIO_PIN_4
#define R_BIN1_GPIO_Port GPIOB
#define R_BIN2_Pin GPIO_PIN_5
#define R_BIN2_GPIO_Port GPIOB
